...
namespace DownloadManagerUI
{
    class DataGridViewProgressCell : DataGridViewImageCell
    {
            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            {
                // Draw the progress 
                g.FillRectangle(new SolidBrush(_ProgressBarColor), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width * 0.97)), cellBounds.Height / 1 - 5); ///////0.97 to add little padding
                //Draw text
